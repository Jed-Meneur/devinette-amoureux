...
/* FOND MAGIQUE ULTRA VISIBLE - COMME IMAGE WHATSAPP */
body::before{
 content:'';position:fixed;inset:0;
 background: 
  radial-gradient(ellipse at 15% 25%, rgba(255,46,126,0.45) 0%, transparent 55%),
  radial-gradient(ellipse at 85% 15%, rgba(248,155,41,0.35) 0%, transparent 55%),
  radial-gradient(ellipse at 50% 85%, rgba(255,46,126,0.25) 0%, transparent 60%),
  radial-gradient(ellipse at 50% 50%, rgba(120,0,50,0.15) 0%, transparent 70%);
 pointer-events:none;z-index:0;
}
body::after{
 content:'💖 ✨ ❤️ 💫 💖 ✨';position:fixed;top:0;left:0;right:0;bottom:0;
 font-size:12px;letter-spacing:60px;line-height:100px;color:rgba(255,255,255,0.07);
 white-space:pre-wrap;pointer-events:none;z-index:0;
}

.hero{position:relative;z-index:1;text-align:center;padding:60px 20px 35px}
.hero h1{font-family:'Playfair Display';font-size:48px;line-height:0.95;font-weight:800;letter-spacing:-1px;text-shadow:0 0 30px rgba(255,46,126,0.8), 0 0 60px rgba(255,46,126,0.3)}
...
.badge{display:inline-flex;align-items:center;gap:6px;margin-top:18px;background:rgba(255,46,126,0.15);border:1px solid rgba(255,46,126,0.4);padding:8px 16px;border-radius:100px;font-size:12px;color:#ff7aa2;backdrop-filter:blur(10px);box-shadow:0 0 20px rgba(255,46,126,0.3)}
.hero p{color:#b0b0b0;margin-top:22px;max-width:420px;margin-left:auto;margin-right:auto;font-size:15px;line-height:1.6}
.stats{display:flex;justify-content:center;gap:28px;margin-top:28px}
.stat b{font-size:22px;display:block;color:white}
...
.card{background:linear-gradient(180deg, rgba(255,255,255,0.09), rgba(255,255,255,0.03));backdrop-filter:blur(18px);border:1px solid rgba(255,255,255,0.1);padding:22px;border-radius:24px;margin-bottom:16px;transition:all 0.4s;box-shadow:0 0 0 1px rgba(255,46,126,0.15), 0 8px 32px rgba(0,0,0,0.6)}
.card:hover{border-color:rgba(255,46,126,0.4);transform:translateY(-2px);box-shadow:0 12px 40px rgba(255,46,126,0.2)}
.card:focus-within{border-color:#ff2e7e;box-shadow:0 0 0 4px rgba(255,46,126,0.15), 0 12px 40px rgba(255,46,126,0.25);transform:scale(1.01)}
.card label{font-weight:700;font-size:14px;color:#fff}
...
.grand{background: linear-gradient(135deg,#ff0f7b 0%,#f89b29 100%);padding:2.5px;border-radius:26px;margin-top:14px;box-shadow:0 0 50px rgba(255,47,126,0.5);animation:pulse 2.5s infinite}
@keyframes pulse{0%,100%{box-shadow:0 0 30px rgba(255,47,126,0.4)}50%{box-shadow:0 0 70px rgba(255,47,126,0.7)}}
.grand-inner{background:radial-gradient(circle at 50% 0%, #1f0e17, #111);border-radius:24px;padding:24px}
...
button{width:100%;margin-top:24px;background: linear-gradient(90deg,#ff0f7b,#f89b29);color:white;font-weight:800;padding:19px;border-radius:100px;border:none;font-size:16px;letter-spacing:0.8px;cursor:pointer;box-shadow:0 10px 30px rgba(255,47,126,0.5);transition:0.3s;text-transform:uppercase}
button:hover{transform:translateY(-2px);box-shadow:0 15px 45px rgba(255,47,126,0.7)}
...
.testi{min-width:220px;background:rgba(255,255,255,0.05);padding:14px 16px;border-radius:18px;font-size:12.5px;color:#999;border:1px solid rgba(255,255,255,0.08);backdrop-filter:blur(10px)}
</style>
</head>
<body>
<div class="hero">
...
<div class="card" style="border:1.5px solid rgba(255,77,136,0.6);">
